...
#define CUSTOM_MACHINE_NAME "Monoprice Mini Delta"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 61.7 // mm
    // Set the steprate for papertest probing
    #define PROBE_MANUALLY_STEP 0.025
  #endif

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 61.7 // mm

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 120.8 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 120.00 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 61.7 //mm  Get this value from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.0, 80.0, 80.0, 291.0 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    // Synthesizes intermediate points to puce a more detailed mesh.
    //
